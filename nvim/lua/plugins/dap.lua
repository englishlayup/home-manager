return {
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>dq', function() dap.terminate() end,
        { desc = 'Dap: Terminate Session (q)' })
      vim.keymap.set('n', '<leader>du', function() require 'dapui'.toggle() end,
        { desc = 'Dap: Toggle UI (u)' })
